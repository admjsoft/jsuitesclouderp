...
class Ticket_model extends CI_Model
{
    ...
    public $doccolumn_order = array('id', 'subject', 'created', null);
    ...
    public function addreply($thread_id, $message, $filename)
    {
        ...
        if ($valid['cid'] == $this->session->userdata('user_details')[0]->cid) {
            ...
            if (isset($multi[0])) {
                return $this->db->insert_batch('gtg_tickets_th', $multi);
            }
    ...
    public function addticket($subject, $message, $filename)
    {
    ...
    public function ticket_datatables()
    {
    ...
    public function ticket_count_filtered()
    {
        $this->ticket_datatables_query();
        $query = $this->db->get();
