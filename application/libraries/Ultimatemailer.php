...
class Ultimatemailer
{
    ...
    public function corn_mail($host, $port, $auth, $auth_type, $username, $password, $mailfrom, $mailfromtilte, $mailto, $mailtotilte, $subject, $message, $attachmenttrue, $attachment)
    {
        include_once APPPATH . '/third_party/PHPMailer/vendor/autoload.php';
        //Create a new PHPMailer instance
        $mail = new PHPMailer();
    ...
    public function group_load($host, $port, $auth, $auth_type, $username, $password, $mailfrom, $mailfromtilte, $recipients, $subject, $message, $attachmenttrue, $attachment, $flag=true)
    {
        include_once APPPATH . '/third_party/PHPMailer/vendor/autoload.php';
    ...
    public function bin_send($host, $port, $auth, $auth_type, $username, $password, $mailfrom, $mailfromtilte, $mailto, $mailtotilte, $subject, $message, $attachmenttrue, $attachment)
    {
        include_once APPPATH . '/third_party/PHPMailer/vendor/autoload.php';
        //Create a new PHPMailer instance
        $mail = new PHPMailer();
