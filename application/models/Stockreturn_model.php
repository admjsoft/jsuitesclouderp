...
{
    public $table = 'gtg_stock_r';
    public $column_order = array(null, 'gtg_stock_r.tid', 'name', 'gtg_stock_r.invoicedate', 'gtg_stock_r.total', 'gtg_stock_r.status', null);
    public $column_search = array('gtg_stock_r.tid', 'name', 'gtg_stock_r.invoicedate', 'gtg_stock_r.total', 'gtg_stock_r.status');
    public $order = array('gtg_stock_r.tid' => 'desc');
    ...
    public function purchase_delete($id)
    {
        ...
        if (($stock['i_class'] != 2 && $this->aauth->premission(2)) or ($stock['i_class'] == 2 && $this->aauth->premission(1))) {
            ...
            if ($this->db->affected_rows()) {
                $this->db->delete('gtg_stock_r_items', array('tid' => $id));
            }
    ...
    public function get_datatables($type = 0)
    {
